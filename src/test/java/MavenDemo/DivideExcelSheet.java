package MavenDemo;
	...
	public class DivideExcelSheet {

	    private final String fileName;
	    private final int maxRows;

	    public DivideExcelSheet(String fileName, final int maxRows) {
	    ...
	    public static void main(String[] args){
	        ...
	        new DivideExcelSheet("C:\\Users\\shubham.o.gupta\\Desktop\\CLOSURE REPORT.xlsx", 1000);
	    }
}
